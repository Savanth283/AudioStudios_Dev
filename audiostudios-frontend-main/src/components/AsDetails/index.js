...
function Loading() {
    return <h2 className='content-center justify-center py-7'>🌀 Loading...</h2>;
  }

const AsDetails = ({data,slug,defaultPriceObject,reviewData,middleAddData,bottomAdddData}) => {
// console.log("middleAddData",middleAddData)
  return (
    <>
    {/* ------ Header Wraper Start */}
    <Suspense fallback={<Loading />}>
    <DetailsSlider data={data.Gallery_details} codeName={data.code_name} />
    </Suspense>
    {/* ------ Header Wraper End */}
            ...
            <div className="flex flex-wrap flex-row">
                ...
                <div className='w-full 2xl:w-[70%] xl:w-[65%] lg:w-[60%] lg:pr-4'>
                    <div className='flex md:flex-row flex-wrap'> 
                        ...
                        <ShareButton title={data.code_name} url={slug} type={data.user_type} />
                    ...
                    <div className="mt-6 md:mt-8 lg:mt-10">
                        ...
                        <div className="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-3 gap-3">
                            ...
                            {data.studio_details?.acoustic_type && (
                            <div className="flex items-center">
                                <RiCheckboxCircleFill className='text-lg lg:text-2xl text-_teal'/>
                            ...
                            {data.studio_details?.audio_interface && (
                            <div className="flex items-center">
                                <RiCheckboxCircleFill className='text-lg lg:text-2xl text-_teal'/>
                    ...
                    {data.creators_details && data.creators_details.languages.length != 0 && (
                    <div className="mt-6 md:mt-8 lg:mt-10">
                    ...
                    {data.creators_details && data.creators_details.instruments.length != 0 && (
                    <div className="mt-6 md:mt-8 lg:mt-10">
                    ...
                    {data.creators_details && data.creators_details.genres.length != 0 && (
                    <div className="mt-6 md:mt-8 lg:mt-10">
...
{/*                             
                    ...
                    <div className="mt-6 md:mt-8 lg:mt-10">
                        ...
                        <div className="my-6 text-center block md:hidden">
                            <Link href={middleAddData[0]?.ad_link} className="block" target='_blank'>
